<template>
    <li>
        <router-link :to="para"
            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group hover:text-emerald-600 dark:hover:text-emerald-500">
