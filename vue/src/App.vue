...
:root {
    /*General*/
    --dp-font-family: "Open Sans", "Helvetica Neue", sans-serif;
    ...
    --dp-input-padding: 6px 5px 5px 32px; /*Padding in the input*/
...
.dp__theme_dark {
    ...
    --dp-highlight-color: rgba(4, 38, 71, 0.2);
