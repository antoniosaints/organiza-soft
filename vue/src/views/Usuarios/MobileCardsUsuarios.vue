  ...
  <ul class="grid w-full gap-6 md:grid-cols-3">
    <li>
      ...
      >
        <div class="block">
          ...
          <div class="w-full text-lg font-semibold">Lista de usuários</div>
          <div class="w-full text-sm">Gerencie os usuários do sistema</div>
        </div>
      </label>
    </li>
    <li>
      ...
      >
        <div class="block">
          ...
          <div class="w-full text-lg font-semibold">Relatorios</div>
          <div class="w-full text-sm">
            Gerencie os relatorios dos usuários do sistema
          </div>
        </div>
      </label>
    </li>
    <li>
      ...
      >
        <div class="block">
          <svg
            class="mb-2 text-red-600 w-7 h-7"
            fill="currentColor"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
          ...
          <div class="w-full text-lg font-semibold">Configurações</div>
          <div class="w-full text-sm">Gerencie as configuracoes do sistema</div>
        </div>
      </label>
    </li>
  </ul>
