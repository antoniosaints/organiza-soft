<template>
    <div class="font-mono text-sm w-[300px] mx-auto p-4 bg-background border border-background/50">
        ...
        <div class="mb-4">
            <div class="border-b border-background/50 pb-2 mb-2">
                <div class="flex justify-between">
                    ...
                    <span class="w-1/6 text-right">Qtd</span>
                    <span class="w-1/3 text-right">Preço</span>
                </div>
            </div>
        ...
        <div class="border-t border-background/50 pt-2">
            <div class="flex justify-between">
                <span>Subtotal:</span>
