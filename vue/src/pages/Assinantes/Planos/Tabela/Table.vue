<template>
    <div class="mx-auto max-w-7xl">
        <div class="flex justify-between items-center mb-4">
            <div>
                <h2 class="text-2xl font-bold text-foreground">Planos</h2>
                <p class="text-sm font-normal text-foreground hidden md:flex">Listagem de todos os planos
                </p>
            </div>
        ...
        <div class="rounded-lg border shadow-sm overflow-auto">
            ...
            <Table v-show="dataExists">
                ...
                <TableBody>
                    <PlanosRow v-for="data in mainStore.lancamentos" :key="data.id" :data="data" />
                </TableBody>
            </Table>
